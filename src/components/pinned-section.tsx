...
const pinnedProjects = [
  {
    name: "punkroast",
    description: "Modern TypeScript project showcasing clean architecture and best practices.",
    language: "TypeScript",
    languageColor: "var(--syntax-blue)",
    url: "https://github.com/kzolt/punkroast",
  },
  {
    name: "XeroEngine",
    description: "Custom game engine built from scratch in C++, exploring graphics rendering and game systems.",
    language: "C++",
  ...
  {
    name: "RayTracing",
    description: "Ray tracing implementation exploring realistic lighting, reflections, and shadows.",
    language: "C++",
    languageColor: "var(--syntax-purple)",
  ...
  {
    name: "Advent2024",
    description: "Learning Rust through Advent of Code 2024 - solving algorithmic challenges.",
    language: "Rust",
...
export function PinnedSection() {
  return (
    <section id="featured" className="relative px-4 md:px-8 lg:px-16 py-16 scroll-mt-8">
