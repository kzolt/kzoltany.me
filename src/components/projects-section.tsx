...
export function ProjectsSection() {
  ...
  return (
    <section id="projects" className="relative px-4 md:px-8 lg:px-16 py-16 scroll-mt-8">
      <div className="max-w-5xl mx-auto">
        ...
        >
          <div className="flex items-center gap-2 text-sm mb-4">
            ...
            <span className="text-muted-foreground">gh repo list kzolt --json name,description,language</span>
          </div>
        ...
        {error && (
          <div className="text-center py-8 text-sm">
            ...
            <span className="text-muted-foreground"> Failed to fetch repositories</span>
          </div>
        )}
        ...
        >
          <div className="flex items-center gap-2 text-sm mb-4">
            <span className="text-primary">$</span>
            <span className="text-muted-foreground">open https://github.com/kzolt</span>
          </div>
          <Link
  ...
  return (
    ...
    >
      <div className="col-span-4 flex items-center gap-2 min-w-0">
        <span className="text-muted-foreground text-xs w-4">{String(index + 1).padStart(2, '0')}</span>
        ...
        {repo.language && (
          <>
            <span
              ...
              style={{ backgroundColor: languageColors[repo.language] || "var(--muted-foreground)" }}
            />
